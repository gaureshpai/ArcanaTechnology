...
const Footer = () => {
  return (
    <footer className="bg-slate-900 text-white pt-8 pb-1">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300 text-center mt-6">&copy; {new Date().getFullYear()} Border Security System.</p>
          </div>
          <div>
          </div>
        </div>
