            ...
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                ...
                <div className="mt-12 grid gap-16 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-12">
                    <div>
                        ...
                        <Link href="/#bss" className="mt-4 text-sm font-medium text-indigo-600 hover:text-indigo-500">
                    ...
                    <div>
                        ...
                        <Link href="/#ssp" className="mt-4 text-sm font-medium text-indigo-600 hover:text-indigo-500">
                            Learn more <span aria-hidden="true">&rarr;</span>
                        </Link>
                    </div>
                </div>
